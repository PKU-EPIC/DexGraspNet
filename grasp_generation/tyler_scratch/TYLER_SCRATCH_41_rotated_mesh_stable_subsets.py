...
# %%
existing_meshdata_path = pathlib.Path("/juno/u/tylerlum/github_repos/DexGraspNet/data/rotated_meshdata_stable")
...
new_meshdata_folders = [
    existing_meshdata_path.parent / f"2024-05-06_rotated_meshdata_stable_{i}"
