...
data_folder = pathlib.Path("../data/2024-03-10_75bottle/raw_evaled_grasp_config_dicts")
assert data_folder.exists()
new_data_folder = pathlib.Path("../data/2024-03-10_75bottle_augmented_pose_HALTON_400/grasp_config_dicts")
