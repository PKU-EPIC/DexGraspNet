...
data_folder = pathlib.Path("../data/2024-03-10_75vase/raw_evaled_grasp_config_dicts")
assert data_folder.exists()
new_data_folder = pathlib.Path("../data/2024-03-10_75vase_augmented_pose_HALTON_400/grasp_config_dicts")
new_data_folder.mkdir(parents=True, exist_ok=False)
...
for data_path in data_paths:
    ...
    if num_successes < N_SUCCESSFUL:
        print(f"{data_path.name} has {num_successes} successful grasps")
        continue
...
plt.hist(num_successes_list, bins=20)
