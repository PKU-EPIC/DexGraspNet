...
data_folder = pathlib.Path("../data/2024-03-10_39box/raw_evaled_grasp_config_dicts")
assert data_folder.exists()
new_data_folder = pathlib.Path("../data/2024-03-10_39box_augmented_pose_HALTON_rot_500/grasp_config_dicts")
