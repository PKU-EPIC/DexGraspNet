...
# %%
folders = [
    pathlib.Path(f"/juno/u/tylerlum/github_repos/DexGraspNet/data/2024-04-08_rotated_grasps_{i}/raw_evaled_grasp_config_dicts")
    for i in range(10)
]
...
# %%
import subprocess
new_experiment_folder = pathlib.Path("/juno/u/tylerlum/github_repos/DexGraspNet/data/2024-04-09_rotated_grasps_aggregated/raw_evaled_grasp_config_dicts")
