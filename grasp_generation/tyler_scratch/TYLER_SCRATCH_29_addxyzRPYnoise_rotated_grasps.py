...
# %%
data_folder = pathlib.Path("../data/2024-04-09_rotated_grasps_aggregated/raw_evaled_grasp_config_dicts")
assert data_folder.exists()
new_data_folder = pathlib.Path("../data/2024-04-09_rotated_grasps_aggregated_augmented_pose_HALTON_50/grasp_config_dicts")
