...
# %%
grasp_config_folder = pathlib.Path("../data/2024-04-09_rotated_grasps_aggregated_augmented_pose_HALTON_50/evaled_grasp_config_dicts_train")
...
# %%
output_dir = pathlib.Path("../data/2024-04-09_rotated_grasps_aggregated_augmented_pose_HALTON_50/aggregated_evaled_grasp_config_dicts_train")
