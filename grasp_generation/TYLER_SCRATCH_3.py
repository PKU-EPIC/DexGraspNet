...
data_path = pathlib.Path("../data/PROBE_0_2024-02-07_softball_0-051_5random/evaled_grasp_config_dicts/ddg-ycb_054_softball_0_0510.npy")
...
plt.scatter(data_dict["trans"][:, 0], data_dict["trans"][:, 1], s=0.1, c=passed_sim)
plt.xlabel('x')
plt.ylabel('y')
