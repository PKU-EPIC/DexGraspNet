...
if __name__ == '__main__':
    ...
    object_plotly = object_model.get_plotly_data(args.num, color='lightgreen', opacity=1, pose=pose)
    
    mesh_convex = object_model.object_mesh_list[0].convex_hull
    v = mesh_convex.vertices * object_model.object_scale_tensor[0].max().item()
