...
if __name__ == '__main__':
    ...
    if 'qpos_st' in data_dict:
        ...
        hand_st_plotly = hand_model.get_plotly_data(i=0, opacity=0.5, color='lightblue', with_contact_points=False, pose=pose)
    else:
        hand_st_plotly = []
    hand_model.set_parameters(hand_pose.unsqueeze(0))
    hand_en_plotly = hand_model.get_plotly_data(i=0, opacity=1, color='lightblue', with_contact_points=False, pose=pose)
    ...
    if 'energy' in data_dict:
        ...
        result = f'Index {args.num}  E_fc {E_fc}  E_dis {E_dis}  E_pen {E_pen}  E_tpen {E_tpen}'
