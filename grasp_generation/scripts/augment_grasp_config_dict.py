...
def main(args: ArgParser):
    ...
    if args.add_open_grasps:
        print(f"Adding open grasps with variance {args.open_grasp_var}")
        orig_joint_angles = grasp_config_dict["joint_angles"]

        open_grasp_config_dict = grasp_config_dict.copy()
    ...
    # Add closed grasps.
    if args.add_close_graps:
        print(f"Adding closed grasps with variance {args.closed_grasp_var}")
        orig_joint_angles = grasp_config_dict["joint_angles"]

        closed_grasp_config_dict = grasp_config_dict.copy()
