...
mesh_by_category_folder = pathlib.Path("/home/tylerlum/meshdata_by_category_v2")
assert mesh_by_category_folder.exists()

output_imgs_folder = pathlib.Path("/home/tylerlum/mesh_images_by_category_v2")
...
output_mesh_dir = pathlib.Path("/home/tylerlum/rotated_meshdata_by_category_v2")
...
rotated_mesh_by_category_folder = output_mesh_dir
assert rotated_mesh_by_category_folder.exists()

rotated_output_imgs_folder = pathlib.Path("/home/tylerlum/rotated_mesh_images_by_category_v2")
